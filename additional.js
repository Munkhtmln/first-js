...
// let dosomething1 = () => "something";

// const getAges = (students) => students.map((student) => students.age);
...
//   students.filter((males) => males.gender == "male");
// console.log(maleStudents(students));
...
// const studentsnames = students.filter((student) =>
//   student.name.toLowerCase().includes("b")
// );
...
// const studentsoddages = (students) =>
//   students.filter((student) => student.age % 2 != 0);
// console.log(studentsoddages(students));
